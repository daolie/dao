...
require_once dirname(dirname(__FILE__)).'/src/PhpPresentation/Autoloader.php';
\PhpOffice\PhpPresentation\Autoloader::register();

require_once dirname(dirname(dirname(__FILE__))).'/common/src/Common/Autoloader.php';
